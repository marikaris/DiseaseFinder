...
public class OmimDataRetrieverTest {
     ...
     */
    @Test
    public void testGetOmimResult() throws Exception {
        System.out.println("getOmimResult");
        String omimNumber = "520000";
        OmimDataRetriever instance = new OmimDataRetriever("http://api.europe.omim.org/api/clinicalSynopsis?"
        ...
        JSONObject content = new JSONObject("{\"omim\": { \n"
                ...
                + "\"inheritance\": \"Mitochondrial {UMLS:C0521451} {HPO HP:0001427}\", \n"
                + "\"headAndNeckEars\": \"Deafness, neurosensory {SNOMEDCT:60700002} {ICD10CM:H90.5} {ICD9CM:389.1,389.10} {UMLS:C0018784};\\nImpaired vestibular function {UMLS:C3151930} {HPO HP:0001751 UMLS:C1843865}\", \n"
                + "\"headAndNeckEyes\": \"Pigmentary retinal degeneration {UMLS:C1833999} {HPO HP:0001146 UMLS:C1833999};\\nMacular pattern dystrophy {UMLS:C3551077};\\nNormal visual acuity {SNOMEDCT:82132006} {UMLS:C0234631};\\nConcentric narrowing of visual fields {UMLS:C3151931} {HPO HP:0007981};\\nExternal ophthalmoplegia {SNOMEDCT:19373007} {ICD10CM:H49.88} {ICD9CM:378.55} {UMLS:C0162292} {HPO HP:0000544 UMLS:C0162292};\\nPtosis (less common) {UMLS:C3277642} {HPO HP:0000508 UMLS:C0005745} {EOM ID:1bd157b764ec7aea IMG:Ptosis-small.jpg}\", \n"
                + "\"cardiovascularHeart\": \"Cardiomyopathy (in some) {UMLS:C3551078} {HPO HP:0001638 UMLS:C0878544}\", \n"
                + "\"neurologicCentralNervousSystem\": \"Dizziness {UMLS:C1963093} {HPO HP:0002321 UMLS:C0042571};\\nUnsteady gait {SNOMEDCT:394616008,22631008} {UMLS:C0231686} {HPO HP:0002317 UMLS:C0231686};\\nSeizures {SNOMEDCT:91175000} {ICD10CM:R56.9} {ICD9CM:780.3} {UMLS:C0036572} {HPO HP:0001250 UMLS:C0036572};\\nDysarthria {SNOMEDCT:8011004} {ICD9CM:438.13,784.51} {UMLS:C0013362} {HPO HP:0001260 UMLS:C0013362}\", \n"
                + "\"endocrineFeatures\": \"Diabetes mellitus (NIDDM) {UMLS:C3151929} {HPO HP:0000819}\", \n"
                + "\"laboratoryAbnormalities\": \"Hyperglycemia {SNOMEDCT:237598005,80394007} {ICD10CM:R73.9} {UMLS:C0020456} {HPO HP:0003074 UMLS:C0020456}\", \n"
                ...
                + "\"contributors\": \"Cassandra L. Kniffin - updated : 10/31/2012\", \n"
                ...
                + "\"dateUpdated\": \"Wed, 21 Nov 2012 03:00:00 EST\", \n"
                + "\"externalLinks\": { \n"
                + "\"mgiHumanDisease\": false, \n"
                + "\"dermAtlas\": false, \n"
                + "\"orphanetDiseases\": \"225;;7037;;Maternally-inherited diabetes and deafness\", \n"
                + "\"ordrDiseases\": \"4003;;Diabetes-deafness syndrome, maternally transmitted\", \n"
                + "\"geneticsHomeReferenceIDs\": \"condition;;maternally inherited diabetes and deafness;;maternally-inherited-diabetes-and-deafness\", \n"
                + "\"omiaIDs\": \"000284;;Diabetes mellitus, type II;;;000279;;Diabetes mellitus\", \n"
        ...
        JSONArray clinicalList = new JSONArray(content.get("clinicalSynopsisList").toString());
        content = new JSONObject(clinicalList.get(0).toString());
        JSONObject expResult = new JSONObject(content.get("clinicalSynopsis").toString());
    ...
    public void testGetOmimNumbers() throws Exception {
        ...
        OmimDataRetriever instance = new OmimDataRetriever("http://api.europe.omim.org/api/entry/search?search="
